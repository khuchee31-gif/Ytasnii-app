...
##
## ЭНЭ НЬ 6 мс-ИЙН БАТАЛГАА БИШ. Нэг дуу нь ТАСАЛДАШГҮЙ: төсөв нь
## «дараагийн дууг эхлүүлэх үү» гэдгийг л шийднэ. Хамгийн урт нь
## өрөөний суурь чимээ (88 200 дээж) бөгөөд Helio G25 дээр тэр нь
## нэг кадрт ~0.5-1 секунд авч магадгүй.
##
## Тэр нь ЗӨВШӨӨРӨГДӨНӨ, учир нь: (1) энэ нь ЛОББИД, тоглогч нэрээ
## бичиж байх үед болно — хөдөлгөөнт зүйл байхгүй; (2) 5 секундээс
## богино тул Android-ын ANR хугацаанд ойрхон ч очихгүй; (3) урсгал
## нь үүнээс ЧӨЛӨӨЛӨХ ганц арга байсан бөгөөд тэр нь утсан дээр
## шалгагдаагүй эрсдэл авчирдаг. Саатал нь эрсдэлээс хямд.
var _todo: Array[String] = []
var _slow_ready := false

## ШИНЭ дуу эхлүүлэх шийдвэрийн босго (мс).
##
## Энэ хугацаанаас хэтэрсэн бол тухайн кадрт ӨӨР дуу эхлүүлэхгүй.
## Аль хэдийн эхэлсэн дуу дуустлаа явна (дээрх тайлбарыг үз).
const SLICE_MS := 6
