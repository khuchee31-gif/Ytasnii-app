...
void main() {
  ...
  group('Ажиглагчийн хариу', () {
    ...
    test('товшилт нь ШИВНЭЭНИЙ САНД орно', () {
      // Бүгд 7 рүү товшвол 7 шивнээнд гарах ёстой. Ажиглагчийн товшилт
      // санд ордоггүй байсан бол Ажиглагчтай тоглолт нь шивнээ цөөнтэй
      // болж, тэр өөрөө ялгарах байв.
      //
      // 7-г ЭМЧИЛНЭ: шивнээ нь ЗӨВХӨН амьд үлдсэн хүнийг жагсаадаг.
      final NightReport r = resolveNight(
        night(all),
        fill(<Intent>[
          it(1, Ability.mafiaKill, 7),
      ...
      // Ажиглагчгүй бол тоолол нэгээр бага — тэр нэг нь ЯГ Ажиглагчийнх.
      ...
      expect(without.whisper, contains(7));
    });
  });
