...
void main() {
  ...
  group('Юуг АЛДАГДУУЛАХГҮЙ вэ', () {
    test('ЧАДВАРТАЙ дүрийн бай шивнээнд ОРОХГҮЙ', () {
      // ЭНЭ БОЛ ЗАСВАРЫН ГОЛ ШАЛГАЛТ.
      //
      // Хоёр алуурчин 7-г сонгож, эмч сохроор яг тэр хүнийг аварсан
      // шөнө. Хуучин дүрмээр (бүх товшилт тоологдоно) 7 нь гурван
      // товшилт авч босго яг давж, АМЬД тул `aliveAfter`-ээр
      // шүүгдэхгүй — шивнээ нь «эмч хэнийг аварсныг» зарлана.
      //
      // Хэмжилт: 400 тоглолт × 6 тохиргоонд шивнээ гарсан тохиолдлын
      // 100% нь яг энэ хэв маяг байв.
      final NightState s = night();
      final NightReport r = resolveNight(
        s,
        fill(<Intent>[
      ...
      expect(r.deaths, isEmpty, reason: 'эмч аварсан');
      expect(r.whisper, isEmpty,
          reason: 'ЗУРГААН чадварын товшилт ч шивнээ гаргах ЁСГҮЙ');
    });

    test('Саатуулагчийн товшилт шивнээнд ОРОХГҮЙ', () {
      // Хуучин дүрэм: «Саатуулагчийн товшилт САНД ОРНО, эс бөгөөс
      // шивнээний тоо нэгээр дутаж түүнийг илчилнэ».
      //
      // Шинэ дүрэм дор тэр эрсдэл ҮГҮЙ БОЛНО: ЯМАР Ч чадварын бай
      // санд ордоггүй тул «нэгээр дутах» гэсэн харьцуулалт хийх
      // суурь байхгүй. Сэжиглэл л тоологдоно.
      final NightState s = night();
      final NightReport r = resolveNight(
        s,
        fill(<Intent>[
          it(7, Ability.suspect, 4),
          it(8, Ability.suspect, 4),
          it(5, Ability.roleblock, 4),
        ], s),
      );
      expect(r.whisper, isEmpty,
          reason: 'хоёр сэжиглэл + саатуулалт = 2, босго 3-д хүрэхгүй');
    });
