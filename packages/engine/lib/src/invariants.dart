...
Map<Seat, int> _rebuildTally(List<Intent> sealed) {
  ...
  for (final Intent i in sealed) {
    switch (i.ability) {
      // ЗӨВХӨН СЭЖИГЛЭЛ.
      //
      // Өмнө нь БҮХ чадварын бай санд ордог байв. Тэр нь шивнээг
      // «энэ шөнө хэн рүү очсон» гэсэн жагсаалт болгосон: хоёр
      // алуурчны нэг бай (2 товшилт) дээр эмч сохроор таарвал гурав
      // болж босго яг давдаг, үхээгүй тул `aliveAfter`-ээр шүүгдэхгүй.
      // 400 тоглолт × 6 тохиргооны хэмжилтээр шивнээ гарсан
      // тохиолдлын 100% нь ЭМЧИЙН АВРААГ зарлаж байв. Босгыг өсгөх нь
      // давтамжийг л бууруулсан, хамаарлыг устгаагүй.
      //
      // Одоо чадвартай дүрийн бай НУУЦ (тэр бол Ажиглагчийн ажил),
      // шивнээ нь нэрнийхээ дагуу зөвхөн сэжиглэлийг тоолно.
