...
class GameRoom {
  ...
  /// Шивнээний босго. Зөвхөн тестэд.
  int get debugMinAgree => _setup?.whisperMinAgree ?? 0;

  /// Тухайн шөнө САНАА илгээсэн суудлууд. Зөвхөн тестэд.
  Set<int> get debugIntentActors =>
      _intents.map((eng.Intent i) => i.actor).toSet();
  ...
  /// Сэжиглэгчдийн тэн хагас, хамгийн багадаа хоёр.
  ///
  ///   2 сэжиглэгч → 2 (хоёулаа тохирно)
  ///   3, 4        → 2
  ///   5, 6        → 3
  ///   8           → 4
  static int _minAgree(int suspectors) {
    final int half = (suspectors + 1) ~/ 2;
  ...
  bool _mayActNow(eng.Role r) => switch (_phase) {
        ...
        //
        // ИРГЭН БА ДАРГА Ч ЭНД СЭРНЭ — «хотын шивнээ»-нд товшино.
        //
        // ЯАГААД ЭНЭ ЗААВАЛ ХЭРЭГТЭЙ ВЭ: шивнээний сан нь товшилт
        // бүрийг тоолж, хамгийн олонтой ХОЁР суудлыг НИЙТЭД зарладаг.
        // Хэрэв зөвхөн чадвартай дүрүүд товшдог байсан бол тэр
        // жагсаалт нь «энэ шөнө хэн рүү ОЧСОН» гэсэн утгатай болно:
        // хоёр алуурчин + эмч нэг хүн дээр таарвал босго давж, «эмч
        // хэнийг аварсныг» бүх ширээнд үнэгүй зарлана. Тэр нь
        // Ажиглагчийн чадварыг хэн ч төлөөгүй байж авна гэсэн үг.
        //
        // Бүх амьд хүн товшиход тэр дохио шингэж, шивнээ нь
        // зорилгынхоо дагуу «хэнийг хамгийн олон хүн сэжиглэж байна»
        // болж эргэнэ.
  ...
  List<Outbound> _deal(int nowMs) {
    ...
    // ШИВНЭЭНИЙ БОСГО НЬ СЭЖИГЛЭГЧДИЙН ТООНООС гарна.
    //
    // Тогтмол 3 нь ХЭТ ӨНДӨР байв. Найман суудалд Ажиглагч, Дарга
    // хоёрыг асаавал иргэн ердөө хоёр үлдэнэ (+ дарга = гурван
    // сэжиглэгч). Гурвуулаа долоон суудлаас ЯГ нэгийг сонгох магадлал
    // ~2% — жинхэнэ ботын тоглолтоор хэмжихэд 61 шөнөд ганц ч шивнээ
    // гараагүй. Механик оршин байгаагаа мэдэгдэхгүй бол байхгүйтэй
    // адил.
    //
    // Дүрэм: СЭЖИГЛЭГЧДИЙН ТЭН ХАГАС нь тохирох ёстой, хамгийн багадаа
    // хоёр. Энэ нь «консенсус» гэдэг үгийн утгыг ширээний хэмжээнээс
    // үл хамааран хадгална.
    final int suspectors = d.roleBySeat.values
        .where((eng.Role r) => eng.abilityOf(r) == eng.Ability.suspect)
        .length;
    _setup = eng.Setup(
      n: n,
      roleBySeat: d.roleBySeat,
      whisperMinAgree: _minAgree(suspectors),
    );
