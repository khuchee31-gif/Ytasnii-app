    ...
    test('BotView-ийн талбарууд ЯГ мэдэгдсэн жагсаалттай таарна', () async {
      ...
      expect(_finalFields(_classBody(await _code(_brain), 'BotView')),
          <String, String>{
            ...
            'iAmRevealed': 'bool',
            // НИЙТИЙН: `voteState.candidates`. Дахин санал авахад
            // зөвхөн тэнцсэн нэрсээс сонгоно.
            'voteCandidates': 'List<int>',
            // НИЙТИЙН: үе шатны дараалал бүгдэд ил байдаг тул хэддүгээр
            // шөнө болохыг хүн бүр тоолж чадна.
            'night': 'int',
            'mem': 'BotMemory',
          });
    });
