...
class TableLayout {
  ...
  /// Харж буй суудлын камер — тухайн суудлын мөрөн дээрээс ширээ рүү.
  ///
  /// ТООНУУД ТААМАГЛААГҮЙ, ХЭМЖСЭН. Камерыг суудлын яг дээр тавихад 12
  /// суудлаас ердөө 3 нь дэлгэцэд багтаж байв. Камерыг бага зэрэг АРД нь
  /// (1.30 × радиус) татаж, 0.5 дээш өргөж, хэвтээ өнцгийг 1.75 рад болгоход
  /// 6, 8, 12 суудлын БҮХ тохиолдолд бүгд багтаж байна.
  static const double _backK = 1.30;
  static const double _eyeLift = 0.50;

  Camera3D cameraFor(int viewerSeat) {
    ...
    return Camera3D(
      ...
      // Ширээний голоос бага зэрэг дээш харна — эсрэг талын нүүр гарч ирнэ.
      target: const Vec3(0, 0.15, 0),
      fovX: 1.75,
    );
  }
}
