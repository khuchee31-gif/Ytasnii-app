...
> 🃏 **«ХОТ УНТЛАА» — мафи утасны тоглоомын судалгаа ба зураглал → [`docs/`](docs/README.md)**
> 20 бүлэг судалгаа + 17 бүлэг дизайн, монгол хэл дээр: дүрэм, дүрүүд, балансын математик,
> архитектур, зах зээл, хууль, замын зураг. Эхлэх цэг: [`docs/README.md`](docs/README.md).
